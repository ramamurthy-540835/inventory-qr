  ...
  return <div className="min-h-screen bg-[#f7faf6] pb-22 text-[#18251d]">
    <header className="sticky top-0 z-20 border-b border-[#e6ece2] bg-white/95 px-4 py-3 backdrop-blur md:px-8">
      <div className="mx-auto flex max-w-7xl items-center gap-3">
        <a className="flex shrink-0 items-center gap-2 text-xl font-black tracking-tight text-nelture-700" href="/app"><img className="h-10 w-10 rounded-xl object-cover" src="/nelture-logo.png" alt="Nelture" /><span>Nelture<span className="text-[#9fc45f]">.ai</span></span></a>

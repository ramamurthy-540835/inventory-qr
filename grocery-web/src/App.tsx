...
function App() {
  ...
  const logout = async () => { await fetch('/auth/logout', { method: 'POST' }); localStorage.removeItem('nelture-customer'); window.location.assign('/app/'); };
